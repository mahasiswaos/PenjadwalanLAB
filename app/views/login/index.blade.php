                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="<?php echo URL::to("/login/proses"); ?>" method="post">
                        <div class="form-group"> 
                            ...
                            <div class="col-sm-9">                   
                                <input type="text" name="email" class="form-control" placeholder="hend@gmail.com">  
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <button type="reset" class="btn btn-info"><i class="glyphicon glyphicon-remove-sign"></i>Reset</button>
                            </div>
